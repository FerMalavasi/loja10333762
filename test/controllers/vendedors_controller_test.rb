...
class VendedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendedor" do
    assert_difference('Vendedor.count') do
      post vendedors_url, params: { vendedor: { faixacomissao: @vendedor.faixacomissao, nome: @vendedor.nome, salario: @vendedor.salario } }
    end
  ...
  test "should update vendedor" do
    patch vendedor_url(@vendedor), params: { vendedor: { faixacomissao: @vendedor.faixacomissao, nome: @vendedor.nome, salario: @vendedor.salario } }
